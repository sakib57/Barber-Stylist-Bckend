...
<?php 
    $user_info = session('saloon_admin_info'); 
    //dd($user_info);
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Saloon Admin</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="{{ route('manage_barbers') }}"><i class="fa fa-home"></i>Barbers</a></li>
                  <li><a href="{{ route('manage_users') }}"><i class="fa fa-home"></i>Users</a></li>
                  ...
                  <!--<li><a><i class="fa fa-home"></i>Gallary<span class="fa fa-chevron-down"></span></a>-->
                  <!--  <ul class="nav child_menu">-->
                  ...
                  <!--<li><a href="{{ route('add_schedule') }}"><i class="fa fa-home"></i>Schedule</a>-->
